...
public class PoleCenaBrutto_IT {
    ...
    @Autowired
    private PoleCenaBruttoZmien poleCenaBrutto;
...
//    }
    ...
    private void pobierzPozycje(String numerPozycji) {
        ...
        czekajNaPobranie.until(ExpectedConditions.visibilityOf(poleCenaBrutto.pobierzPoWebElement()));
