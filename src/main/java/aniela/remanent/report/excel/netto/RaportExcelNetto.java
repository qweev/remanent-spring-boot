package aniela.remanent.report.excel.netto;

import aniela.remanent.position.abstraction.Position;
import aniela.remanent.pozycje.BazaRepository;
import aniela.remanent.report.excel.stronyExcela.Skoroszyt;
...
@Service
public class RaportExcelNetto {
    final static Logger logger = Logger.getLogger(RaportExcelNetto.class);
    ...
    public String generujRaport(String sciezka) {
        ...
        pozycje = BazaRepository.przygotujPozycjeDoRaportuNetto();
